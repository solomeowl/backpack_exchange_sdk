...
class AuthenticationClient:
    ...
    def get_order_history(
        self, orderId: str = None, symbol: str = None, limit: int = 100, offset: int = 0
    ):
        """
    ...
    def get_settlement_history(
        self, limit: int = 100, offset: int = 0, source: str = None
    ):
        """
    ...
    def get_users_open_orders(
        self, symbol: str, clientId: int = None, orderId: str = None
    ):
        """
